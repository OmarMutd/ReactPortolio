        ...
        <div className="card">
            <div className="item_item-card one">
                ...
                <div className='txt-box'>
                    ...
                    <p className='about-project'>This project was built with React, Express, and PSQL. It was made for my family owned buisness. It is a website which shows off a extensive Italian Menu.</p>
